...
object GBT extends Serializable {
  ...
  def train(dataset:RDD[LabeledPoint],num_classes:Long,params:Map[String,String]):(GradientBoostedTreesModel,Double) = {
    ...
    boostingStrategy.treeStrategy.numClasses = num_classes.toInt
